...
## Corpus Check
- 91 files · ~49,279 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 225 nodes · 344 edges · 45 communities (36 shown, 9 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c9fd5813`
...
3. `Select()` - 8 edges
4. `compressImage()` - 8 edges
5. `useRole()` - 6 edges
6. `loadEmployees()` - 6 edges
7. `parseNum()` - 6 edges
8. `loadVehicles()` - 6 edges
9. `POST()` - 5 edges
10. `loadData()` - 5 edges
...
Cohesion: 0.27
Nodes (7): useRole(), canViewFinancials(), getRoleFromEmail(), isStaffBlockedPath(), navHrefAllowedForRole(), normalizeEmail(), middleware()
...
- **Why does `useRole()` connect `Community 10` to `Community 0`, `Community 2`, `Community 4`, `Community 7`, `Community 8`?**
